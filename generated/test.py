...
testTitle1 = dali_movie.text("testTitle1", "\"Test de titre\"", duration=15, backgroundColor="red", textColor="white")
dali_movie.add(clip1)
dali_movie.add(clip1a, mode=MODE.START, anchor_type="after", offset=5, reference=clip1)
dali_movie.add(audio1a, mode=MODE.END, anchor_type="at", reference=clip1a)
dali_movie.add(testTitle1, mode=MODE.START, anchor_type="after", reference=clip1a)
testSubtitle1 = dali_movie.text("testSubtitle1", "Je teste les sous-titres", duration=10, textColor="white")

...
clip1a = dali_movie.cut(clip1, 0, 3)
...
print(dali_movie)
dali_movie.add(clip1a, Placement_Mode.AFTER, 1, clip1)
print(dali_movie)
dali_movie.add(clip1c, Placement_Mode.FROM, 3, clip1a)
print(dali_movie)
...
print(dali_movie)
dali_movie.add(introSound, Placement_Mode.AFTER, 1, clip1)
print(dali_movie)

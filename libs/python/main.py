...
#print("ok")
introSound = dali_movie.importAudio("introSound" ,"../data/audio.mp3")
#print("ok")
clip1a = dali_movie.cut("clip1a" ,clip1, 2, 4)
#print("ok")
clip1b = dali_movie.cut_start("clip1b" ,clip1, 1.5)
#print("ok")
clip1c = dali_movie.cut_end("clip1c" ,clip1, 1)
#print("ok")
...
introSound2 = dali_movie.cut("introSound2" ,introSound, 2, 4)
#print(dali_movie)
...
#print("ADD TEXT")
title = dali_movie.text("title" ,"-- I AM THE TITLE --", backgroundColor="black")
title2 = dali_movie.text("title2" ,"-- I AM THE TITLE FOR 2 SEC --", duration=2, backgroundColor="black")
dali_movie.add(title)
#print(dali_movie)
dali_movie.add(title2, MODE.START, 2, ANCHOR_TYPE.AFTER, title)
#print(dali_movie)
subtitle = dali_movie.text("subtitle" ,"-- I AM THE SUBTITLE --")
dali_movie.add(subtitle, MODE.START, None, ANCHOR_TYPE.AT, clip1a)
#print(dali_movie)

result = dali_movie.export()
#print(result)